    ...
    <footer className="text-white py-8 px-8" style={{ backgroundColor: '#0A1A3A' }}>
      <div className="max-w-6xl mx-auto flex justify-between items-center text-xs text-slate-500">
        ...
        <div className="flex gap-4">
          <Link to="/nivel-3/contacto" className="hover:text-white">Politica de Privacidad</Link>
          <Link to="/nivel-3/contacto" className="hover:text-white">Terminos de Uso</Link>
        </div>
      </div>
    </footer>
  )
