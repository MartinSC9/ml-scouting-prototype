...
export default function JugadorReferidos() {
  return (
    <PlayerLayout activeItem="referidos" level={3}>
      ...
      <p className="text-slate-500 mb-8">Comparte tu código y ambos reciben un 10% de descuento.</p>
      ...
      <div className="bg-white rounded-xl border border-slate-100 p-6 mb-8">
        ...
        <div className="grid grid-cols-3 gap-4 mt-6">
          ...
          <div className="text-center p-4 bg-[#f2f4f7] rounded-lg">
            <p className="text-2xl font-bold text-[#0A1A3A]">{'\u20AC'}25</p><p className="text-xs text-slate-500">Crédito ganado</p>
          </div>
        </div>
      </div>
