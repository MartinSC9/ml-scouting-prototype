...
export default function AdminBlog() {
  const articles = [
    { title: 'Cómo preparar tu video highlight para scouts', cat: 'Scouting', catBg: 'bg-blue-50 text-blue-700', status: 'Publicado', statusBg: 'bg-green-50 text-green-700', date: '15 Oct 2026', views: '1,234' },
    { title: 'Las ligas europeas que más buscan talento sudamericano', cat: 'Mercado', catBg: 'bg-green-50 text-green-700', status: 'Publicado', statusBg: 'bg-green-50 text-green-700', date: '10 Oct 2026', views: '987' },
    ...
    { title: 'El rol del mediocampista moderno', cat: 'Análisis Táctico', catBg: 'bg-orange-50 text-orange-700', status: 'Borrador', statusBg: 'bg-yellow-50 text-yellow-700', date: '-', views: '-' },
    { title: 'Qué aprenderás en el Curso de Scouting Profesional', cat: 'Curso', catBg: 'bg-yellow-50 text-yellow-700', status: 'Programado', statusBg: 'bg-blue-50 text-blue-700', date: '1 Nov 2026', views: '-' },
