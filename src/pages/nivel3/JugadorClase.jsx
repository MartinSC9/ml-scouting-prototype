      ...
      <div className="grid md:grid-cols-3 gap-8">
        <div className="md:col-span-2">
          ...
          <div className="bg-white rounded-xl border border-slate-100 p-6 mb-6">
            ...
            <h1 className="text-xl font-bold text-[#0A1A3A] mt-3 mb-2" style={{fontFamily:"'Noto Serif'"}}>Análisis de video: identificando patrones de juego</h1>
        ...
        <div className="bg-white rounded-xl border border-slate-100 p-6 h-fit">
          <h3 className="font-bold text-[#0A1A3A] mb-4">Módulo 2: Observación y Análisis</h3>
