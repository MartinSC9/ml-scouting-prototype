    ...
    <div className="bg-[#f7f9fc] text-[#191c1e]">
      ...
      <main className="pt-28 pb-16 px-8">
        <article className="max-w-3xl mx-auto">
          ...
          <h1 className="text-3xl md:text-4xl font-bold text-[#0A1A3A] mb-4" style={{fontFamily:"'Noto Serif'"}}>Cómo preparar tu video highlight para scouts</h1>
          ...
          <div className="prose max-w-none text-slate-600 leading-relaxed space-y-6">
            <p>El video highlight es tu carta de presentación ante scouts y clubes. En un mercado cada vez más competitivo, tener un video bien editado puede marcar la diferencia entre ser visto o ser ignorado.</p>
            <h2 className="text-xl font-bold text-[#0A1A3A]" style={{fontFamily:"'Noto Serif'"}}>1. Duración ideal</h2>
            <p>Un highlight no debería superar los 3-5 minutos. Los scouts reciben decenas de videos por semana, así que es fundamental ir al grano y mostrar lo mejor de tu repertorio.</p>
            <h2 className="text-xl font-bold text-[#0A1A3A]" style={{fontFamily:"'Noto Serif'"}}>2. Qué incluir</h2>
            <ul className="list-disc pl-6 space-y-2">
              <li>Acciones completas (no solo goles)</li>
              <li>Jugadas que muestren tu perfil táctico</li>
              <li>Momentos de liderazgo y comunicación</li>
            ...
            <p>Evita música de fondo excesiva, efectos visuales innecesarios y clips de entrenamientos. Los scouts quieren ver partidos reales, no producciones cinematográficas.</p>
            <h2 className="text-xl font-bold text-[#0A1A3A]" style={{fontFamily:"'Noto Serif'"}}>4. Formato y distribución</h2>
            <p>Sube tu video a YouTube como no listado y comparte el link. Asegúrate de incluir tu nombre, posición, edad y datos de contacto en la descripción.</p>
          </div>
          ...
          {/* Related */}
          <div className="mt-12">
            <h3 className="text-xl font-bold text-[#0A1A3A] mb-6" style={{fontFamily:"'Noto Serif'"}}>Artículos relacionados</h3>
            <div className="grid md:grid-cols-2 gap-6">
              {[{title:'Las ligas europeas que más buscan talento sudamericano',cat:'Mercado',date:'10 Oct 2026'},{title:'5 errores que cometen los jugadores al buscar club',cat:'Para Jugadores',date:'5 Oct 2026'}].map((a,i)=>(
